...
was converted into this updated [Rcpp
Introduction](https://eddelbuettel.github.io/pinp/Rcpp-introduction.pdf)
...
[rticles](https://cran.r-project.org/package=rticles) package by
\cite{CRAN:rticles}. The conversion from markdown to latex is
facilitated by [rmarkdown](https://cran.r-project.org/package=rmarkdown)
\citep{CRAN:rmarkdown} and
[knitr](https://cran.r-project.org/package=knitr) \citep{CRAN:knitr}.
The underlying LaTeX macros are from
...
-   Setting a DOI or URL footer, for example for the CRAN package URL,
    ...
    pages;
-   Setting a footer label, for example *YourPackage Vignette* stating
...
prefers to show the results and embedding of *R* code.
